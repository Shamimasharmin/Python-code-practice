...
➡ The 2 is found by adding the two numbers before it (1+1)=2

➡ The 3 is found by adding  the two numbers before it (1+2)=3

➡ The 5 is found by adding  the two numbers before it (2+3)=5,
